...
class User(AbstractUser):
    """Default user for couple.
    """
    nickname = models.CharField(null=True, blank=True, max_length=255, verbose_name="昵称")
    job_title = models.CharField(max_length=50, null=True, blank=True, verbose_name="职业")
    ...
    created_at = models.DateTimeField(auto_now_add=True, verbose_name="LinkedIn链接")
